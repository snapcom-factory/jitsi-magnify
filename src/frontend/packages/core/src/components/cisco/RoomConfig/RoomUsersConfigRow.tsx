...
import { UserRowBase, UserRowBaseProps } from '../../users';
...
interface CiscoRoomUsersConfigRowProps extends UserRowBaseProps<RoomUser> {
...
export const CiscoRoomUsersConfigRow = ({ ...props }: CiscoRoomUsersConfigRowProps) => {
  const intl = useIntl();
